...
export default function Dashboard() {
  ...
  // Filter logic and check the status
  useEffect(() => {
    let data = books;
  ...
  // Status change from dropdown List
...
const completed = books?.filter((b) => b.status === "Completed")?.length || 0;
  ...
  return (
    <div className="min-h-screen w-full p-6 bg-gradient-to-br from-purple-200 to-violet-400">
